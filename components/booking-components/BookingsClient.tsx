...
import CancelBookingDialog from "@/components/booking-components/CancelBookingDialog";
...
export default function BookingsClient() {
  ...
  const [selectedBooking, setSelectedBooking] = useState<Cleaning | null>(null);
  ...
  const handleCancelClick = (booking: Cleaning) => {
